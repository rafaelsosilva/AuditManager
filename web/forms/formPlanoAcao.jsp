<%-- 
    Document   : formPlanoAcao
    Created on : 31 de mar. de 2024, 14:17:38
    Author     : rafaelsilva
--%>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="menu.jsp" method="POST">
                ...
                <label for="fname">Titulo Plano de Acao</label>
                <input type="text" id="nomeAuditoria" name="nomeAuditoria" placeholder="Titulo Plano de Acao">
                
                <label for="fname">Descricao Plano de Acao</label>
                <input type="text" id="nomeAuditoria" name="nomeAuditoria" placeholder="Desricao do Plano de Acao">
